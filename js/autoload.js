...
if (location.href === `http://localhost:4000/` || location.href === `https://www.rhhz.top/`) {
  ...
  live2d_settings['modelTexturesId'] = 19;            // 默认材质 ID
  live2d_settings['modelStorage'] = false;           // 不储存模型 ID
  live2d_settings['canCloseLive2d'] = false;         // 隐藏 关闭看板娘 按钮
  live2d_settings['canTurnToHomePage'] = false;      // 隐藏 返回首页 按钮
  live2d_settings['waifuSize'] = '250x250';          // 看板娘大小
  live2d_settings['waifuTipsSize'] = '250x130';      // 提示框大小
  live2d_settings['waifuFontSize'] = '20px';         // 提示框字体
  live2d_settings['waifuEdgeSide'] = 'right:200';     // 看板娘贴边方向
  live2d_settings['waifuToolFont'] = '30px';         // 工具栏字体
  ...
  initModel({
    ...
    "seasons": [
      ...
      { "date": "10/01", "text": ["<span style=\"color:#0099cc;\">国庆节</span>，新中国已经成立{year - 1949}年了呢"] },
      { "date": "11/05-11/12", "text": ["今年的<span style=\"color:#0099cc;\">双十一</span>是和谁一起过的呢~"] },
      { "date": "12/20-12/24", "text": ["过几天是<span style=\"color:#0099cc;\">圣诞节</span>，主人肯定又去剁手买买买了~"] },
      { "date": "12/25", "text": ["今天是<span style=\"color:#0099cc;\">圣诞节</span>，主人肯定又去剁手买买买了~"] }
    ]
  });
}
